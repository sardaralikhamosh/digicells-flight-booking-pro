<div class="wrap">
    ...
    <div id="dcfb-flight-form" style="display:none; margin-top:20px; background:#f1f1f1; padding:20px; border-radius:5px;">
        ...
        <form method="post" action="<?php echo admin_url('admin-post.php'); ?>">
            ...
            <table class="form-table">
                ...
                <tr><th>Origin (Airport Code)</th><td><input type="text" name="origin_code" required placeholder="e.g., JFK"></td></tr>
                <tr><th>Destination (Airport Code)</th><td><input type="text" name="dest_code" required placeholder="e.g., LHR"></td></tr>
                <tr><th>Price (optional)</th><td><input type="number" step="0.01" name="price" placeholder="0.00"></td></tr>
                <tr><th>Featured Image</th><td><input type="hidden" name="image_url" id="flight-image-url"><button type="button" class="button" id="upload-image-btn">Upload Image</button><br><img id="flight-image-preview" style="max-width:200px; margin-top:10px; display:none;"></td></tr>
            </table>
    ...
    <table class="wp-list-table widefat fixed striped">
        ...
        <tbody>
        <?php if ($flights): foreach ($flights as $f): ?>
            <tr>
                <td><?php echo $f->id; ?></td>
                ...
                <td><?php echo $f->price ? '$'.esc_html($f->price) : '-'; ?></td>
                <td><a href="<?php echo wp_nonce_url(admin_url('admin-post.php?action=dcfb_delete_flight&id='.$f->id), 'dcfb_delete_flight'); ?>" onclick="return confirm('Delete this flight?')">Delete</a></td>
            </tr>
        <?php endforeach; else: ?>
